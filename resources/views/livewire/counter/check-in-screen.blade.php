        ...
        @if ($noLocation)
            ...
            <div class="rounded-2xl border border-line bg-surface p-8 text-center dark:border-slate-800 dark:bg-slate-900">
                ...
                <p class="mt-1 text-sm text-ink-muted dark:text-slate-400">
                    {{ $mustChooseLocation ? __('Trabajas en varias sedes. Selecciona en la barra superior en cuál estás.') : __('No tienes ninguna sede activa. Pide a un responsable que te asigne una para usar la recepción.') }}
                </p>
            </div>
        @else
            {{-- Flash --}}
