    ...
    @if (count($rows) === 0)
        <x-filament::section>
            <div style="text-align:center;padding:2.5rem 1rem;">
                <x-filament::icon icon="heroicon-o-check-circle" style="width:2.5rem;height:2.5rem;color:#16a34a;margin:0 auto .5rem;" />
                    ...
                    <tbody>
                        @foreach ($rows as $row)
                            <tr style="border-bottom:1px solid #eef2f7;vertical-align:top;">
                                ...
                                <td style="padding:.5rem .6rem;max-width:28rem;"><span style="color:#dc2626;">{{ $row['exception'] }}</span></td>
