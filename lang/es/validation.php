...
|--------------------------------------------------------------------------
|
| Created by prompt 169. lang/ held only en.json and es.json, neither carrying a
| single validation.* key, and .env ships APP_LOCALE=es WITH APP_FALLBACK_LOCALE=es —
| so Laravel's own bundled English file was never consulted either and every
| validation failure in the Spanish product rendered a raw key (validation.required,
| validation.accepted on an Article 9 consent tick). The full framework set is
| published and translated, not a partial file of the rules in use today: a partial
| one would silently print a key again the next time anybody adds a rule.
|
*/
...
return [
    ...
    'attributes' => [
        ...
        'photo' => 'foto',
        'consent_data' => 'consentimiento de tratamiento de datos',
        'consent_statutes' => 'aceptación de los estatutos',
        'declared_monthly_g' => 'consumo mensual estimado',
        'avalador_ref' => 'avalador',
        'is_therapeutic' => 'uso terapéutico',
        'kind' => 'tipo',
        'mode' => 'modo',
        'value_pct' => 'porcentaje',
        'locations' => 'sedes',
        'roles' => 'roles',
        'active' => 'activo',
        'notes' => 'notas',
